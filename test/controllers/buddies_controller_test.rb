...
class BuddiesControllerTest < ActionController::TestCase
  ...
  test "should create buddy" do
    assert_difference('Buddy.count') do
      post :create, buddy: { can_feed: @buddy.can_feed, can_schedule: @buddy.can_schedule, register_id: @buddy.register_id, user_id: @buddy.user_id }
    end
  ...
  test "should update buddy" do
    patch :update, id: @buddy, buddy: { can_feed: @buddy.can_feed, can_schedule: @buddy.can_schedule, register_id: @buddy.register_id, user_id: @buddy.user_id }
    assert_redirected_to buddy_path(assigns(:buddy))
  end
